...
async def run_browser_agent(
    ...
    try:
        ...
        llm = utils.get_llm_model(
            provider="gemini", # Hardcoded to Gemini
            ...
            with gr.TabItem("🔧 LLM Configuration", id=2):
                with gr.Group():
                    llm_provider = gr.Dropdown(
                        choices=["gemini"], # Removed other providers
                        label="LLM Provider",
                        value="gemini", # Default to Gemini
                        interactive=False, # Make it non-interactive as only Gemini is supported
